...
// * Scroll Buttons + Return Button
const scrollButtons = $("<div>").addClass("scroll-buttons");
const returnButton = $("<button>").addClass("return-button").text("Return");
...
if (mode === "multiplayer") {
  $(scrollButtons).addClass("multiplayer");
  ...
  $(scrollButtons).append(leftArrow, returnButton, rightArrow);
}

if (mode === "single player") {
  $(scrollButtons).addClass("singleplayer");
  $(scrollButtons).append(returnButton);
}
