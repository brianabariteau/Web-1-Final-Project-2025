...
const avatar1BackgroundBox = $("<img>")
  .addClass("background-boxes")
  .attr("src", "./assets/parchment-box.png")
  .attr("alt", "Background Boxes");
...
const avatar2BackgroundBox = $("<img>")
  .addClass("background-boxes")
  .attr("src", "./assets/parchment-box.png")
  .attr("alt", "Background Boxes");
...
const avatar3BackgroundBox = $("<img>")
  .addClass("background-boxes")
  .attr("src", "./assets/parchment-box.png")
  .attr("alt", "Background Boxes");
...
function updateAvatarsDisplay() {
  ...
  $(avatar1).append(avatar1BackgroundBox.clone());
  $(avatar2).append(avatar2BackgroundBox.clone());
  $(avatar3).append(avatar3BackgroundBox.clone());
}
...
function selectCharacter(avatarElement, character) {
  $(".avatar1, .avatar2, .avatar3").css("box-shadow", "none");
  $(avatarElement).css("box-shadow", "0px 5px 5px rgba(0, 0, 0, 0.6)");
...
const textBox = $("<img>")
  .addClass("box")
  .attr("src", "./assets/choose-character-text.png")
  .attr("alt", "Text Box"); */
...
/*const confirmImg = $("<img>")
  .addClass("buttonImg")
  .attr("src", "./assets/parchment-confirm-button.png")
  .attr("alt", "Confirm Button Image"); 

$(confirmButton).append(confirmImg); */
...
/*const cancelImg = $("<img>")
  .addClass("buttonImg")
  .attr("src", "./assets/parchment-cancel-button.png")
  .attr("alt", "Cancel Button Image");
...
$(cancelButton).on("click", () => {
  ...
  selectedPlayer = null;
  $(avatar1).css("box-shadow", "none");
  $(avatar2).css("box-shadow", "none");
  $(avatar3).css("box-shadow", "none");
});

$(leftButton).append(confirmButton);
$(rightButton).append(cancelButton);
$(bottomPanel).append(leftButton, textBox, rightButton);
