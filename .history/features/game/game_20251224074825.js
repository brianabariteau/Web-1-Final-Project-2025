...
const player1ability1 = $("<button>")
  ...
  .on("click", () => {
    executeAbility(player1Character, "ability1use", 1);
  });
const player1ability2 = $("<button>")
  .addClass("player1-ability2")
  .on("click", () => {
    executeAbility(player1Character, "ability2use", 2);
  });
...
const player2ability1 = $("<button>")
  ...
  .on("click", () => {
    executeAbility(player2Character, "ability1use", 1);
  });
const player2ability2 = $("<button>")
  .addClass("player2-ability2")
  .on("click", () => {
    executeAbility(player2Character, "ability2use", 2);
  });
