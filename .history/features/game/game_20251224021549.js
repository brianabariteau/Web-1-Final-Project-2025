...
function executeMove(attacker, defender, moveNum) {
  ...
  console.log(attacker.stats.power);
  console.log(attacker.stats.speed);
...
function gameOver(player) {
  const gameOver = $("<div>")
    ...
    .append($("<h1>").text(`${player.name} is the victor!`))
    .append(
      $("<button>")
        .text("Play Again.")
    ...
    .append(
      $("<button>")
        ...
        .on("click", () => window.location.href = "../main-menu/main-menu.html"))
    );
...
const player1Move1 = $("<button>")
  .addClass("moves")
  .on("click", () => {
    executeMove(player1Character, player2Character, "move1use");
  });
const player1Move2 = $("<button>")
  .addClass("moves")
  .on("click", () => {
    executeMove(player1Character, player2Character, "move2use");
  });
const player1Move3 = $("<button>")
  .addClass("moves")
  .on("click", () => {
    executeMove(player1Character, player2Character, "move3use");
  });
const player1Move4 = $("<button>")
  .addClass("moves")
  .on("click", () => {
    executeMove(player1Character, player2Character, "move4use");
  });
...
const player2Move1 = $("<button>")
  .addClass("moves")
  .on("click", () => {
    executeMove(player2Character, player1Character, "move1use");
  });
const player2Move2 = $("<button>")
  .addClass("moves")
  .on("click", () => {
    executeMove(player2Character, player1Character, "move2use");
  });
const player2Move3 = $("<button>")
  .addClass("moves")
  .on("click", () => {
    executeMove(player2Character, player1Character, "move3use");
  });
const player2Move4 = $("<button>")
  .addClass("moves")
  .on("click", () => {
    executeMove(player2Character, player1Character, "move4use");
  });
