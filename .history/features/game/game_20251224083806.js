...
function updateGameDisplay() {
  ...
  player1Move1.find(".label").text(CHARACTER_MOVES[player1].move1name);
  player1Move2.find(".label").text(CHARACTER_MOVES[player1].move2name);
  player1Move3.find(".label").text(CHARACTER_MOVES[player1].move3name);
  player1Move4.find(".label").text(CHARACTER_MOVES[player1].move4name);
  player1Move1.find(".tooltip-text").text(CHARACTER_MOVES[player1].move1desc);
  player1Move2.find(".tooltip-text").text(CHARACTER_MOVES[player1].move2desc);
  player1Move3.find(".tooltip-text").text(CHARACTER_MOVES[player1].move3desc);
  player1Move4.find(".tooltip-text").text(CHARACTER_MOVES[player1].move4desc);

  player1ability1.find(".label").text(CHARACTER_MOVES[player1].ability1name);
  player1ability2.find(".label").text(CHARACTER_MOVES[player1].ability2name);
  player1ability1
    .find(".tooltip-text")
    .text(CHARACTER_MOVES[player1].ability1desc);
  player1ability2
    .find(".tooltip-text")
    .text(CHARACTER_MOVES[player1].ability2desc);
  ...
  player2Move1.find(".label").text(CHARACTER_MOVES[player2].move1name);
  player2Move2.find(".label").text(CHARACTER_MOVES[player2].move2name);
  player2Move3.find(".label").text(CHARACTER_MOVES[player2].move3name);
  player2Move4.find(".label").text(CHARACTER_MOVES[player2].move4name);
  player2Move1.find(".tooltip-text").text(CHARACTER_MOVES[player2].move1desc);
  player2Move2.find(".tooltip-text").text(CHARACTER_MOVES[player2].move2desc);
  player2Move3.find(".tooltip-text").text(CHARACTER_MOVES[player2].move3desc);
  player2Move4.find(".tooltip-text").text(CHARACTER_MOVES[player2].move4desc);

  player2ability1.find(".label").text(CHARACTER_MOVES[player2].ability1name);
  player2ability2.find(".label").text(CHARACTER_MOVES[player2].ability2name);
  player2ability1
    .find(".tooltip-text")
    .text(CHARACTER_MOVES[player2].ability1desc);
  player2ability2
    .find(".tooltip-text")
    .text(CHARACTER_MOVES[player2].ability2desc);
}
...
function executeAbility(character, opponent, abilityNum, buttonNum) {
  if (isGameOver) return;

  const characterName = character.name;

  const ability = CHARACTER_MOVES[characterName]?.[abilityNum];

  ability(character, opponent);

  let abilityName = "ability";
  if (buttonNum === 1) {
    abilityName = CHARACTER_MOVES[character.name].ability1name;
  } else if (buttonNum === 2) {
    abilityName = CHARACTER_MOVES[character.name].ability2name;
  }

  $(panel).text(`${character.name} used the ability ${abilityName}!`);
...
const player1Move1 = $("<button>")
  ...
  .append($("<span>").addClass("tooltip-text"))
  .on("click", () => {
...
const player1ability1 = $("<button>")
  ...
  .append($("<span>").addClass("tooltip-text"))
  .on("click", () => {
    executeAbility(player1Character, player2Character, "ability1use", 1);
  });
const player1ability2 = $("<button>")
  ...
  .append($("<span>").addClass("tooltip-text"))
  .on("click", () => {
    executeAbility(player1Character, player2Character, "ability2use", 2);
  });
...
const player2ability1 = $("<button>")
  ...
  .append($("<span>").addClass("tooltip-text"))
  .on("click", () => {
    executeAbility(player2Character, player1Character, "ability1use", 1);
  });
const player2ability2 = $("<button>")
  ...
  .append($("<span>").addClass("tooltip-text"))
  .on("click", () => {
    executeAbility(player2Character, player1Character, "ability2use", 2);
  });
