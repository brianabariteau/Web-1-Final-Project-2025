...
function renderCharacterAbilities(character) {
  return `
    <div class="character">
      <div class="inner-character">
        <p>${CHARACTER_MOVES[character.name].ability1name}</p> ABILITY 1
        <p>${CHARACTER_MOVES[character.name].ability2name}</p> ABILITY 2
      </div>
    </div>
  `;
}
...
function updateGameDisplay() {
  ...
  // ? Player 2
  player2Name.text(player1Name.name);
  player2Move1.text(CHARACTER_MOVES[player1Name].move1name);
  player2Move2.text(CHARACTER_MOVES[player1Name].move2name);
  player2Move3.text(CHARACTER_MOVES[player1Name].move3name);
  player2Move4.text(CHARACTER_MOVES[player1Name].move4name);
}
