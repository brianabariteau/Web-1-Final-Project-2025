...
function executeAbility(character, moveNum, buttonNum) {
  if (isGameOver) return;

  const characterName = character.name;

  const ability = CHARACTER_MOVES[characterName]?.[moveNum];
  console.log(move);
...
const player1ability1 = $("<button>")
  ...
  .on("click", () => {
    executeAbility(player1Character, 1);
  });
const player1ability2 = $("<button>")
  .addClass("player1-ability2")
  .on("click", () => {
    executeAbility(player1Character, 2);
  });
...
const player2ability1 = $("<button>")
  ...
  .on("click", () => {
    executeAbility(player2Character, 1);
  });
const player2ability2 = $("<button>")
  .addClass("player2-ability2")
  .on("click", () => {
    executeAbility(player2Character, 2);
  });
