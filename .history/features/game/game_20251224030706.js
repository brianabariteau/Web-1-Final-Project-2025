...
function playerTurns() {
  if (currentTurn === "player1") {
    $(".player1-battle").prop("disabled", false).css("filter", "none");
    $(".player2-battle").prop("disabled", true).css("opacity", "80%");
  } else if (currentTurn === "player2") {
    $(".player2-battle button").prop("disabled", false).css("filter", "none");
    $(".player1-battle button").prop("disabled", true).css("opacity", "80%");
  }
}
