...
function playerTurns() {
  if (currentTurn === "player1") {
    $(".player1-battle button").prop("disabled", false).css("opacity", "1");
    $(".player2-battle button").prop("disabled", true).css("opacity", "0.5");
  } else if (currentTurn === "player2") {
    $(".player2-battle button").prop("disabled", false).css("opacity", "1");
    $(".player1-battle button").prop("disabled", true).css("opacity", "0.5");
  }
}
